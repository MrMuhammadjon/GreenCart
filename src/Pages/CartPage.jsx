...
const CartPage = () => {
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-20 m-auto w-[90%]">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    Shopping Cart <span className="text-xl text-green-500">{getCartCount()} Items</span>
                </h1>
                ...
                <button onClick={() => navigate('/')} className="group cursor-pointer flex items-center mt-8 gap-2 text-green-500 font-medium hover:-translate-x-1 transition-[0.3s]">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selecteAddress ? `${selecteAddress.street}, ${selecteAddress.city}, ${selecteAddress.state}, ${selecteAddress.country}` : "Not Found Addres"}</p>
                            ...
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {
                                    addresses.map((item, index) => {
                                        return (
                                            <p onClick={() => { setSelectAdddres(item); setShowAddress(false) }} className="text-gray-500 p-2 hover:bg-gray-100">
                                                {item.street}, {addresses.city}, {addresses.state}, {addresses.country}
                                            </p>
                                        )
                                    })
                                }
                    ...
                    <select onChange={e => setPaymetOtion(e.target.value)} className="w-full border border-gray-300 bg-white px-3 py-2 mt-2 outline-none">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    <p className="flex justify-between">
                        <span>Price</span><span>${currency}{getCartAmout()}</span>
                    </p>
                    <p className="flex justify-between">
