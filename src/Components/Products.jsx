...
const Products = ({ product }) => {
    ...
    return product && (
        <>
            ...
            <div className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-42 max-w-60 w-full">
                ...
                <div className="text-gray-500/60 text-sm">
                    ...
                    <div className="flex items-center gap-0.5">
                        {Array(5).fill('').map((_, i) => (
                            <img key={i} className='md:w-3.5 w3' w src={i < 4 ? assets.star_icon : assets.star_dull_icon} />
